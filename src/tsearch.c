/* A complete, with destroy function, implementation of tsearch from
 * the GNU C library, included within B-Em for cases where the system
 * C library is missing the destory function. */
